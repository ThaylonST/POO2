...
private PedidoDAO pedidoDAO;
    ...
    private void jButtonListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonListarActionPerformed
        ...
        for (PedidoDTO p : pedidoDAO.listarPedidos()) {
            pedidos.append("Pedido ").append(p.getNumeroDoPedido())
                   .append(" - Cliente: ").append(p.getCliente())
                   .append(" - Total: R$ ").append(p.getTotal()).append("\n");
        }
        JOptionPane.showMessageDialog(this, pedidos.length() == 0 ? "Nenhum pedido cadastrado." : pedidos.toString());
    }//GEN-LAST:event_jButtonListarActionPerformed

    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        try {
            int numeroDoPedido = Integer.parseInt(jTextField1.getText());
            String cliente = jTextField3.getText();
            String[] itensArray = jTextField2.getText().split(","); // Dividindo os itens por vírgula
            ...
            PedidoDTO pedido = new PedidoDTO(numeroDoPedido, cliente, itens, total);
            pedidoDAO.adicionarPedido(pedido);
            JOptionPane.showMessageDialog(this, "Pedido salvo com sucesso!");
        } catch (NumberFormatException ex) {
            JOptionPane.showMessageDialog(this, "Erro nos dados inseridos. Verifique os campos.");
        }
